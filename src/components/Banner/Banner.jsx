...
const Banner = () => {
    return (
        <div className="hero min-h-96 bg-[#1313130D] p-8 md:p-10 rounded-3xl">
            <div className="hero-content flex-col lg:flex-row-reverse">
                ...
                <div className="lg:pe-28 ">
                    ...
                    <button><a className="btn btn-sm md:btn-md lg:btn-lg bg-[#40A2D8] text-white md:text-lg">View The List</a></button>
                </div>
            </div>
        </div>
    );
